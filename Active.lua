local C = {
	Ownership = { --Reversed UserIDS
		8097716262
	},
	ReplaceLocalCWithServerC = true, -- determines if the local static config file will be replaced with the one from the server
	Detecting = { -- Settings determining how the script will 
		...
		AvoidHTTPS = true, -- script will only use the local static config file
